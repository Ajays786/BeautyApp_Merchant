...
//        highlightIconColor = UIColor.init(red: 254/255.0, green: 73/255.0, blue: 42/255.0, alpha: 1.0)
        ...
        highlightTextColor = UIColor.init(red: 108/255.0, green: 25/255.0, blue: 170/255.0, alpha: 1.0)
        iconColor = UIColor.init(red: 132/255.0, green: 132/255.0, blue: 132/255.0, alpha: 1.0)
        highlightIconColor = UIColor.init(red: 108/255.0, green: 25/255.0, blue: 170/255.0, alpha: 1.0)
    }
...
class ExampleIrregularityBasicContentView: ExampleBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        highlightTextColor = UIColor.init(red: 254/255.0, green: 94/255.0, blue: 74/255.0, alpha: 1.0)
        iconColor = UIColor.init(white: 255.0 / 255.0, alpha: 1.0)
        highlightIconColor = UIColor.init(red: 254/255.0, green: 94/255.0, blue: 74/255.0, alpha: 1.0)
        backdropColor = UIColor.init(red: 82/255.0, green: 80/255.0, blue: 76/255.0, alpha: 1.0)
        highlightBackdropColor = UIColor.init(red: 82/255.0, green: 80/255.0, blue: 76/255.0, alpha: 1.0)
    }
