...
class RegisterController: UIViewController, UINavigationControllerDelegate, UITextFieldDelegate {
    ...
    @objc func handleRegister() {
        ...
        if repeatPassword != password {
            ...
            self.passwordTextField.attributedPlaceholder = NSAttributedString(string: "Please double check your password", attributes: [NSAttributedString.Key.foregroundColor: UIColor.red])
            return
        }
            ...
            if error != nil {
                if let errCode = AuthErrorCode(rawValue: error!._code) {
                    ...
                    case .emailAlreadyInUse:
                        ...
                        self.passwordTextField.text = ""
                        self.passwordRepeatTextField.text = ""
                        self.emailTextField.attributedPlaceholder = NSAttributedString(string: "🌚 Account has existed", attributes: [NSAttributedString.Key.foregroundColor: UIColor.red])
                    case .weakPassword:
                        self.passwordTextField.shake(2, withDelta: 4, speed: 0.07)
                        self.passwordTextField.text = ""
                        self.passwordRepeatTextField.text = ""
                        self.passwordTextField.attributedPlaceholder = NSAttributedString(string: "🌚 Your password is too weak", attributes: [NSAttributedString.Key.foregroundColor: UIColor.red])
                    default:
                        self.emailTextField.shake(2, withDelta: 4, speed: 0.07)
                        self.passwordTextField.shake(2, withDelta: 4, speed: 0.07)
                        self.emailTextField.text = ""
